...
const STEPS = [
  { label: 'Step 1 of 5', question: "What's your native language?", sub: 'So we know how to explain things to you' },
  { label: 'Step 2 of 5', question: 'What do you want to learn?', sub: 'Pick the language you want to speak' },
  { label: 'Step 3 of 5', question: 'Pick your dialect', sub: 'Each dialect has its own voice, slang, and culture' },
  { label: '', question: 'Save your progress', sub: 'Create a free account to keep your streak and vocab' },
  { label: 'Step 4 of 5', question: "What's your name?", sub: "We'll use this to personalise your experience" },
  { label: 'Step 5 of 5', question: "What's your daily goal?", sub: 'You can change this anytime' },
];
      ...
      <div className="onboard-new">
        ...
        {step === 3 && (
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '8px' }}>
            ...
            <button className="welcome-new-cta" onClick={handleShowAuth} style={{ marginTop: '4px' }}>
              Create free account →
            </button>
          </div>
        )}
